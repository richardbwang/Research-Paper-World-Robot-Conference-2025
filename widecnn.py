...
# --- Config ---
IMAGE_DIR = "/"
CSV_PATH = "./train.filename01train"
IMG_SIZE = (224, 224)
BATCH_SIZE = 32
...
prev_input = Input(shape=(3,), name="prev_label_input")
...
combined = layers.Concatenate()([x, prev_input])
x = layers.Dense(32, activation='relu')(x)
output = layers.Dense(1)(combined)

model = Model(inputs=[image_input, prev_input], outputs=output)
...
# --- Save & Evaluate ---
model.save("regression_model_wide01.h5")
